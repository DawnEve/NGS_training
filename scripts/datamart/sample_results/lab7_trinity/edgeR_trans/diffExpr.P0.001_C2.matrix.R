...
source("/share/apps/trinityrnaseq_r20140717/Analysis/DifferentialExpression/R/misc_rnaseq_funcs.R")
source("/share/apps/trinityrnaseq_r20140717/Analysis/DifferentialExpression/R/pairs3.R")
data = primary_data
samples_data = read.table("/home/cliu/TrinityTutorial_exercise2/samples_file", header=F, check.names=F)
